...
//   ndn::AppHelper consumerHelper("ns3::ndn::ConsumerCbr");
  ...
  //int i = 0;
  printFIBmoreData (consumer1, "FIB_Consumer1_WiFi.txt", control);
  printPIT (consumer1, "PIT_Consumer1_WiFi.txt", control);
  printCS(consumer1, "CS_Consumer1_WiFi.txt", control);
  showPosition (consumer1, deltaTime, "Mobility_Consumer1_WiFi.txt", control);

  printFIBmoreData (consumer2, "FIB_Consumer2_WiFi.txt", control);
  printPIT (consumer2, "PIT_Consumer2_WiFi.txt", control);
  printCS(consumer2, "CS_Consumer2_WiFi.txt", control);
  showPosition (consumer2, deltaTime, "Mobility_Consumer2_WiFi.txt", control);

  printFIBmoreData (consumer3, "FIB_Consumer3_WiFi.txt", control);
  printPIT (consumer3, "PIT_Consumer3_WiFi.txt", control);
  printCS(consumer3, "CS_Consumer3_WiFi.txt", control);
  showPosition (consumer3, deltaTime, "Mobility_Consumer3_WiFi.txt", control);

  printFIBmoreData (consumer4, "FIB_Consumer4_WiFi.txt", control);
  printPIT (consumer4, "PIT_Consumer4_WiFi.txt", control);
  printCS(consumer4, "CS_Consumer4_WiFi.txt", control);
  showPosition (consumer4, deltaTime, "Mobility_Consumer4_WiFi.txt", control);
...
// Producer
  ...
  // A producer for push-based emergency messages
  ...
  printFIBmoreData (consumer5, "FIB_Consumer5_WiFi.txt", control);
  printPIT (consumer5, "PIT_Consumer5_WiFi.txt", control);
  printCS(consumer5, "CS_Consumer5_WiFi.txt", control);
  showPosition (consumer5, deltaTime, "Mobility_Consumer5_WiFi.txt", control);



  // For producer (s)
  printFIBmoreData (producer1, "FIB_Producer1_WiFi.txt", false);
  printPIT (producer1, "PIT_Producer1_WiFi.txt", false);
  printCS (producer1, "CS_Producer1_WiFi.txt", false);
  showPosition (producer1, deltaTime, "Mobility_Producer1_WiFi.txt", false);

  printFIBmoreData (producer2, "FIB_Producer2_WiFi.txt", false);
  printPIT (producer2, "PIT_Producer2_WiFi.txt", false);
  printCS (producer2, "CS_Producer2_WiFi.txt", false);
  showPosition (producer2, deltaTime, "Mobility_Producer2_WiFi.txt", false);
...
//   ndn::L3AggregateTracer::InstallAll ("aggregate-ndn-simple-wifi.txt", Seconds (2));
  ndn::L3RateTracer::InstallAll ("rate-ndn-simple-wifi.txt", Seconds (5));
