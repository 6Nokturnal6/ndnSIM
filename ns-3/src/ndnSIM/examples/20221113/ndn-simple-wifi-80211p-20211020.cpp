...
// 	LogComponentEnable ("ndn.WifiExample.20201020",LOG_LEVEL_DEBUG);
	NS_LOG_COMPONENT_DEFINE ("ndn.WifiExample.80211p.20201020");
...
//   }
	...
	// For producer
  printFIBmoreData (producer, "FIB_Node1.txt", false);
  printPIT (producer, "PIT_Node1.txt", false);
  printCS (producer, "CS_Node1.txt", false);
...
// 		case 1:	{consumerHelper.SetPrefix("/prefix/Node/"); break;}
        ...
        case 12:	{consumerHelper.SetPrefix("/prefix/Node/"); break;}
//         case 13:	{consumerHelper.SetPrefix("/prefix/Node/"); break;}
...
// 		}
        ...
        case 12: {
            printFIBmoreData (nodes.Get(i), "FIB_Node12.txt", control);
            printPIT (nodes.Get(i), "PIT_Node12.txt", control);
            printCS(nodes.Get(i), "CS_Node12.txt", control);
            break;
        }
//         case 13: {
//             printFIBmoreData (nodes.Get(i), "FIB_Node13.txt", control);
//             printPIT (nodes.Get(i), "PIT_Node13.txt", control);
//             printCS(nodes.Get(i), "CS_Node13txt", control);
//             break;
//         }
        default:
...
// 				   MakeBoundCallback (&CourseChange, &os));
  ...
  ndn::L3RateTracer::InstallAll("ndn-simple-wifi80211p-20211020_1.txt", Seconds(5));
  AnimationInterface anim("vehicularmobility_20211020_1.xml");
  Simulator::Run();
  Simulator::Destroy();
