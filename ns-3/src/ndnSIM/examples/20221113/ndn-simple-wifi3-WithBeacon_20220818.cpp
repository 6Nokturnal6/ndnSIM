...
//   ndn::AppHelper consumerHelper("ns3::ndn::ConsumerCbr");
  ...
  consumerHelper.SetPrefix("/test/prefix/consumer_"+std::to_string(nodes.Get(0)->GetId()));
  ...
  consumerHelper.SetPrefix("/test/prefix/consumer_"+std::to_string(nodes.Get(2)->GetId()));
  consumerHelper.SetAttribute("Frequency", DoubleValue(50.0));//100
  auto consumer2 = nodes.Get(2);
  auto appConsumer2 = consumerHelper.Install(consumer2);
//   appConsumer2.Stop(Seconds(6.0));

  consumerHelper.SetPrefix("/test/prefix/consumer_"+std::to_string(nodes.Get(4)->GetId()));
  consumerHelper.SetAttribute("Frequency", DoubleValue(50.0));//100
  auto consumer3 = nodes.Get(4);
  auto appConsumer3 = consumerHelper.Install(consumer3);
  appConsumer3.Start(Seconds(0.0));

  consumerHelper.SetPrefix("/test/prefix/consumer_"+std::to_string(nodes.Get(5)->GetId()));
  ...
  consumerHelper1.SetPrefix("/beacon/RSU_"+std::to_string(nodes.Get(7)->GetId()));
...
//   std::string tmp_dir = "/home/dasilva/PDEEC2021/testingENV/ns-3/testingVM_logs/";
  ...
  showPosition (consumer1, deltaTime-2, tmp_dir + "Mobility_Node_" + std::to_string(nodes.Get(0)->GetId()) + ".txt", control);
  ...
  showPosition (consumer2, deltaTime-2, tmp_dir + "Mobility_Node_" + std::to_string(nodes.Get(2)->GetId()) + ".txt", control);
  ...
  showPosition (consumer3, deltaTime-2, tmp_dir + "Mobility_Node_" + std::to_string(nodes.Get(4)->GetId()) + ".txt", control);
  ...
  showPosition (consumer4, deltaTime-2, tmp_dir + "Mobility_Node_" + std::to_string(nodes.Get(5)->GetId()) + ".txt", control);
  ...
  showPosition (RSU0, deltaTime-2, tmp_dir + "Mobility_Node_" + std::to_string(nodes.Get(7)->GetId()) + ".txt", control);
...
//   appProducer1.Stop(Seconds(10.0));
  ...
  showPosition (consumer5, deltaTime-2, tmp_dir + "Mobility_Node_"+std::to_string(nodes.Get(3)->GetId()) + ".txt", control);
  ...
  showPosition (producer1, deltaTime-2, tmp_dir + "Mobility_Node_"+std::to_string(nodes.Get(1)->GetId()) + ".txt", false);
  ...
  showPosition (producer2, deltaTime-2, tmp_dir + "Mobility_Producer2_WiFi.txt", false);
  ...
  showPosition (producer3, deltaTime-2, tmp_dir + "Mobility_Node_"+std::to_string(nodes.Get(3)->GetId()) + ".txt", false);
  ...
  showPosition (nodes.Get(10), deltaTime-2, tmp_dir + "Mobility_Node_"+std::to_string(nodes.Get(10)->GetId()) + ".txt", false);// 3 seconds
  ...
  showPosition (nodes.Get(11), deltaTime-2, tmp_dir + "Mobility_Node_" + std::to_string(nodes.Get(11)->GetId()) + ".txt", false);// 3 seconds
