...
//   appProducer1.Stop(Seconds(10.0));
  ...
  printFIBmoreData (nodes.Get(10), tmp_dir + "FIB_Router11_WiFi.txt", false);
  printPIT (nodes.Get(10), tmp_dir + "PIT_Router11_WiFi.txt", false);
  printCS (nodes.Get(10), tmp_dir + "CS_Router11_WiFi.txt", false);
  showPosition (nodes.Get(10), deltaTime-2, tmp_dir + "Mobility_Router11_WiFi.txt", false);// 3 seconds

  printFIBmoreData (nodes.Get(11), tmp_dir + "FIB_Router12_WiFi.txt", false);
  printPIT (nodes.Get(11), tmp_dir + "PIT_Router12_WiFi.txt", false);
  printCS (nodes.Get(11), tmp_dir + "CS_Router12_WiFi.txt", false);
  showPosition (nodes.Get(11), deltaTime-2, tmp_dir + "Mobility_Router12_WiFi.txt", false);// 3 seconds
