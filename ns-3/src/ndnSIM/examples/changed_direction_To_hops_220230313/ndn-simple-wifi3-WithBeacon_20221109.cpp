...
//   std::string tmp_dir = "/home/dasilva/PDEEC2021/testingENV/ns-3/testingVM_logs/";
  ...
  //int i = 0;
  printFIBmoreData (consumer1, tmp_dir + "FIB_Consumer_" + std::to_string(nodes.Get(0)->GetId()) + ".txt", control);
  printPIT (consumer1, tmp_dir + "PIT_Consumer_" + std::to_string(nodes.Get(0)->GetId()) + ".txt", control);
  printCS(consumer1, tmp_dir +  "CS_Consumer_" + std::to_string(nodes.Get(0)->GetId()) + ".txt", control);
  showPosition (consumer1, deltaTime, tmp_dir + "Mobility_Node_" + std::to_string(nodes.Get(0)->GetId()) + ".txt", control);

  printFIBmoreData (consumer2, tmp_dir + "FIB_Consumer_" + std::to_string(nodes.Get(2)->GetId()) + ".txt", control);
  printPIT (consumer2, tmp_dir + "PIT_Consumer_" + std::to_string(nodes.Get(2)->GetId()) + ".txt", control);
  printCS(consumer2, tmp_dir + "CS_Consumer_" + std::to_string(nodes.Get(2)->GetId()) + ".txt", control);
  showPosition (consumer2, deltaTime, tmp_dir + "Mobility_Node_" + std::to_string(nodes.Get(2)->GetId()) + ".txt", control);

  printFIBmoreData (consumer3, tmp_dir + "FIB_Consumer_" + std::to_string(nodes.Get(4)->GetId()) + ".txt", control);
  printPIT (consumer3, tmp_dir + "PIT_Consumer_" + std::to_string(nodes.Get(4)->GetId()) + ".txt", control);
  printCS(consumer3, tmp_dir + "CS_Consumer_" + std::to_string(nodes.Get(4)->GetId()) + ".txt", control);
  showPosition (consumer3, deltaTime, tmp_dir + "Mobility_Node_" + std::to_string(nodes.Get(4)->GetId()) + ".txt", control);

  printFIBmoreData (consumer4, tmp_dir + "FIB_Consumer_" + std::to_string(nodes.Get(5)->GetId()) + ".txt", control);
  printPIT (consumer4, tmp_dir + "PIT_Consumer_" + std::to_string(nodes.Get(5)->GetId()) + ".txt", control);
  printCS(consumer4, tmp_dir + "CS_Consumer_" + std::to_string(nodes.Get(5)->GetId()) + ".txt", control);
  showPosition (consumer4, deltaTime, tmp_dir + "Mobility_Node_" + std::to_string(nodes.Get(5)->GetId()) + ".txt", control);

  printFIBmoreData (RSU0, tmp_dir + "FIB_RSU_" + std::to_string(nodes.Get(7)->GetId()) + ".txt", control);
  printPIT (RSU0, tmp_dir + "PIT_RSU_" + std::to_string(nodes.Get(7)->GetId()) + ".txt", control);
  printCS(RSU0, tmp_dir + "CS_RSU_" + std::to_string(nodes.Get(7)->GetId()) + ".txt", control);
  showPosition (RSU0, deltaTime, tmp_dir + "Mobility_Node_" + std::to_string(nodes.Get(7)->GetId()) + ".txt", control);
  ...
  printFIBmoreData (consumer5, tmp_dir + "FIB_Consumer_" + std::to_string(nodes.Get(3)->GetId()) + ".txt", control);
  printPIT (consumer5, tmp_dir + "PIT_Consumer_" + std::to_string(nodes.Get(3)->GetId()) + ".txt", control);
  printCS (consumer5, tmp_dir + "CS_Consumer_" + std::to_string(nodes.Get(3)->GetId()) + ".txt", control);
  showPosition (consumer5, deltaTime, tmp_dir + "Mobility_Node_" + std::to_string(nodes.Get(3)->GetId()) + ".txt", control);


  ndn::AppHelper consumerHelper3("ns3::ndn::ConsumerCRoMo2");
  consumerHelper3.SetPrefix("/cromo/test/prefix/consumer_" + std::to_string(nodes.Get(13)->GetId()));
  consumerHelper3.SetAttribute("Frequency", DoubleValue(50.0));//100
  auto consumer6 = nodes.Get(13);
  auto appConsumer6 = consumerHelper3.Install(consumer6);
  appConsumer6.Start(Seconds(0.0));

  printFIBmoreData (nodes.Get(13), tmp_dir + "FIB_Consumer_" + std::to_string(nodes.Get(13)->GetId()) + ".txt", control);
  printPIT (nodes.Get(13), tmp_dir + "PIT_Consumer_" + std::to_string(nodes.Get(13)->GetId()) + ".txt", control);
  printCS (nodes.Get(13), tmp_dir + "CS_Consumer_" + std::to_string(nodes.Get(13)->GetId()) + ".txt", control);
  showPosition (nodes.Get(13), deltaTime, tmp_dir + "Mobility_Node_" + std::to_string(nodes.Get(13)->GetId()) + ".txt", control);
...
//   appProducer1.Stop(Seconds(10.0));
  ...
  // For producer (s)
  printFIBmoreData (producer1, tmp_dir + "FIB_Producer_" + std::to_string(nodes.Get(1)->GetId()) + ".txt", false);
  printPIT (producer1, tmp_dir + "PIT_Producer_" + std::to_string(nodes.Get(1)->GetId()) + ".txt", false);
  printCS (producer1, tmp_dir + "CS_Producer_" + std::to_string(nodes.Get(1)->GetId()) + ".txt", false);
  showPosition (producer1, deltaTime, tmp_dir + "Mobility_Node_"+std::to_string(nodes.Get(1)->GetId()) + ".txt", false);
  ...
  printFIBmoreData (producer3, tmp_dir + "FIB_Producer_" + std::to_string(nodes.Get(3)->GetId()) + ".txt", false);
  printPIT (producer3, tmp_dir + "PIT_Producer_" + std::to_string(nodes.Get(3)->GetId()) + ".txt", false);
  printCS (producer3, tmp_dir + "CS_Producer_" + std::to_string(nodes.Get(3)->GetId()) + ".txt", false);
  showPosition (producer3, deltaTime, tmp_dir + "Mobility_Node_"+std::to_string(nodes.Get(3)->GetId()) + ".txt", false);
  ...
  printFIBmoreData (nodes.Get(11), tmp_dir + "FIB_Router_"+std::to_string(nodes.Get(11)->GetId()) + ".txt", false);
  printPIT (nodes.Get(11), tmp_dir + "PIT_Router_" + std::to_string(nodes.Get(11)->GetId()) + ".txt", false);
  printCS (nodes.Get(11), tmp_dir + "CS_Router_" + std::to_string(nodes.Get(11)->GetId()) + ".txt", false);
  showPosition (nodes.Get(11), deltaTime, tmp_dir + "Mobility_Node_" + std::to_string(nodes.Get(11)->GetId()) + ".txt", false);// 3 seconds
...
//   Simulator::Schedule (Seconds (0.0), &showPosition, producer, deltaTime); // Schedule to print node velocity status
  ...
  ndn::AppDelayTracer::InstallAll(tmp_dir + "delay-ndn-simple-wifi3-WithBeacon_20220818.txt");
//   ndn::L3AggregateTracer::InstallAll ("aggregate-ndn-simple-wifi.txt", Seconds (2));
  ndn::L3RateTracer::InstallAll (tmp_dir + "rate-ndn-simple-wifi3-WithBeacon_20220818.txt", Seconds (5));
  AnimationInterface anim(tmp_dir + "vehicularmobility_ndn-simple-wifi3-WithBeacon_20220818.xml");
