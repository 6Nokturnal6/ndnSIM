...
//   ndn::AppHelper consumerHelper("ns3::ndn::ConsumerCbr");
  ...
  // consumerHelper.SetPrefix("/prefix/example_estimates.png");
  consumerHelper.SetAttribute("FileToRequest", StringValue("/cromo/test/Scenario.png"));
  consumerHelper.SetAttribute("WriteOutfile", StringValue("/home/dasilva/PDEEC2021/testingENV/ns-3/clientFolder/Scenario_rec_nodeNum-" + std::to_string(nodeNum) + "_RngRun-" + std::to_string(RngRun) + ".png"));
  ...
  //  ndn::AppHelper consumerHelper("ns3::ndn::FileConsumer");
  // // consumerHelper.SetPrefix("/prefix/example_estimates.png");
  // consumerHelper.SetAttribute("FileToRequest", StringValue("/cromo/test/Limetorrents.flv"));
  // // consumerHelper.SetAttribute("Frequency", DoubleValue(0.5));
...
// Producer
  ...
  // producerHelper.SetAttribute("PayloadSize", StringValue("2200"));
