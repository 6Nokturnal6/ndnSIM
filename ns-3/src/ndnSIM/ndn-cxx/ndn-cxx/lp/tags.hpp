...
// typedef SimpleTag<uint64_t, 14> NonDiscoveryTag; //-- Elidio
 ...
 * This tag can be attached to Interest, Data, Nack.
 */
class SpeedTag; // 0x60000002, defined directly in speed-tag.hpp


/** \class origId
 *  \brief a packet tag for origId field
 *
 *  This tag can be attached to Interest, Data.
 */
// typedef SimpleTag<uint32_t, 16> origIdTag;

/** \class fromId
 *  \brief a packet tag for fromId field
 *
 *  This tag can be attached to Interest, Data.
 */
typedef SimpleTag<uint64_t, 0x60000003> fromIdTag;

/** \class destIdTag
 *  \brief a packet tag for destId field
 *
 *  This tag can be attached to Interest, Data.
 */
typedef SimpleTag<uint64_t, 0x60000004> destIdTag; // Used in forwarding as the endpointId (relay nodeId)

/** \class timestampTag
 *  \brief a packet tag for timestamp field
 *
 *  This tag can be attached to Interest, Data.
 */
typedef SimpleTag<uint64_t, 0x60000005> timestampTag;
