...
// false,
// NonNegativeIntegerTag,
// NonNegativeIntegerTag> origIdField;
// BOOST_CONCEPT_ASSERT((Field<origIdField>));
...
typedef FieldDecl<field_location_tags::Header,
                  ...
                  false,
                  NonNegativeIntegerTag,
                  NonNegativeIntegerTag> fromIdField;
BOOST_CONCEPT_ASSERT((Field<fromIdField>));
...
typedef FieldDecl<field_location_tags::Header,
                  ...
                  false,
                  NonNegativeIntegerTag,
                  NonNegativeIntegerTag> destIdField;
BOOST_CONCEPT_ASSERT((Field<destIdField>));
...
typedef FieldDecl<field_location_tags::Header,
                  ...
                  false,
                  NonNegativeIntegerTag,
                  NonNegativeIntegerTag> timestampField;
BOOST_CONCEPT_ASSERT((Field<timestampField>));
