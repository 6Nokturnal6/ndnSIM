...
public: // Data fields
  ...
  Data& 
  setOrigID(const std::string&);
  
  // destFinalID
  const std::string& getDestFinalID() const
  {
	  return m_destFinalId;
  }

  Data&
  setDestFinalID(const std::string&);

  // Coordinates
  
  /*const double& getsCoordX() const
  {
	  return m_sCoordX;
  }
  
  Data& 
  setsCoordX(const double&)*/;
  
  // Coord Y ======================================
  
//   const double& getsCoordY() const
//   {
// 	  return m_sCoordY;
//   }
//
//   Data&
//   setsCoordY(const double&);
...
//
//   Data&
//   setSpeedY(const double&);
  
  // Time ===============================
//   const uint32_t& getTimeA() const
//   {
// 	  return m_TimeA;
//   }
//
//   Data&
//   setTimeA(const uint32_t&);
  
  // Speed Y ======================================
  
//   const uint32_t& getTimeD() const
//   {
// 	  return m_TimeD;
//   }
//
//   Data&
//   setTimeD(const uint32_t&);
  
  
  // Direction ===============================
//   const uint32_t& getDirection() const
//   {
// 	  return m_Direction;
//   }
//
//   Data&
//   setDirection(const uint32_t&);
...
//
//   Data&
//   setAcceleration(const double&);
  
  // destID ======================================
//   const std::string& getDestID() const
//   {
// 	  return m_destID;
//   }
//
//   Data&
//   setDestID(const std::string&);
  
  // bcID ======================================
//   const std::string& getBcID() const
//   {
// 	  return m_bcID;
//   }
//
//   Data&
//   setBcID(const std::string&);
...
private:
  ...
  /* Begin Elidio ************************************/
  std::string m_origId = "ff:ff:ff:ff:ff:dd";
  std::string m_destFinalId = "ff:ff:ff:ff:ff:dd";
//   double m_sCoordX = 0.0;
//   double m_sCoordY = 0.0;
//   double m_SpeedX = 0.0;
//   double m_SpeedY = 0.0;
//   uint32_t m_TimeA = 8;
//   uint32_t m_TimeD = 9;
...
//   std::string m_destID = "00:00:00:00:ff:ff";
//   std::string m_bcID = "66:66:66:66:ff:ff";
