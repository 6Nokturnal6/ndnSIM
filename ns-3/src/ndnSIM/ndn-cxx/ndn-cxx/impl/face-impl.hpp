...
public: // consumer
                       ...
                       const TimeoutCallback& afterTimeout)
  {
    ...
    /* Elidio*/
//     addFieldFromTag<lp::origIdField, lp::origIdTag>(lpPacket, interest2);
    // addFieldFromTag<lp::destIdField, lp::destIdTag>(lpPacket, interest2);
    // addFieldFromTag<lp::fromIdField, lp::fromIdTag>(lpPacket, interest2);
    // addFieldFromTag<lp::timestampField, lp::timestampTag>(lpPacket, interest2);
    // addFieldFromTag<lp::SpeedTagField, lp::SpeedTag>(lpPacket, interest2);
    // addFieldFromTag<lp::GeoTagField, lp::GeoTag>(lpPacket, interest2);
    /***************/
...
public: // producer
  ...
  asyncPutData(const Data& data)
  {
    ...
    addFieldFromTag<lp::CongestionMarkField, lp::CongestionMarkTag>(lpPacket, data);
        ...
        /* Elidio*/
//     addFieldFromTag<lp::origIdField, lp::origIdTag>(lpPacket, data);
    addFieldFromTag<lp::destIdField, lp::destIdTag>(lpPacket, data);
    addFieldFromTag<lp::fromIdField, lp::fromIdTag>(lpPacket, data);
    addFieldFromTag<lp::timestampField, lp::timestampTag>(lpPacket, data);
    addFieldFromTag<lp::SpeedTagField, lp::SpeedTag>(lpPacket, data);
    addFieldFromTag<lp::GeoTagField, lp::GeoTag>(lpPacket, data);
    /***************/
