...
addFieldFromTag(lp::Packet& lpPacket, const Packet& packet)
{
  ...
  if (tag != nullptr) {
    ...
    // std::cout << "lp-field-tag.hpp (addFieldFromTag) - SOMETHING WORKS!! " << std::endl;
  }
  // else
    // std::cout << "lp-field-tag.hpp (addFieldFromTag) - NOTHING WORKS!! " << std::endl;
}
...
addTagFromField(Packet& packet, const lp::Packet& lpPacket)
{
  if (lpPacket.has<Field>()) {
    ...
    // std::cout << "lp-field-tag.hpp (addTagFromField) - SOMETHING WORKS!! " << std::endl;
  }
  // else
    // std::cout << "lp-field-tag.hpp (addTagFromField) - NOTHING WORKS!! " << std::endl;
}
