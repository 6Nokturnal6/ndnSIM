...
// // Field in Data/Interest https://www.programmersought.com/article/14675398024/
...
private:
  ...
  /* Begin Elidio ************************************/
  std::string m_origId = "ff:ff:ff:ff:ff:aa";
  std::string m_destFinalId = "ff:ff:ff:ff:ff:aa";
  /* End Elidio****************************************/
