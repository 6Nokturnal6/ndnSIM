...
extractLpLocalFields(NetPkt& netPacket, const lp::Packet& lpPacket)
{
  ...
  /*Elidio*/
  addTagFromField<lp::fromIdTag, lp::fromIdField>(netPacket, lpPacket);
  addTagFromField<lp::destIdTag, lp::destIdField>(netPacket, lpPacket);
  addTagFromField<lp::timestampTag, lp::timestampField>(netPacket, lpPacket);
  addTagFromField<lp::GeoTag, lp::GeoTagField>(netPacket, lpPacket);
  addTagFromField<lp::SpeedTag, lp::SpeedTagField>(netPacket, lpPacket);
