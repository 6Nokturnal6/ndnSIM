...
Interest::wireDecode(const Block& wire)
{
  ...
  /************************************************/
  /* Begin Elidio ************************************/
  m_origId = "ff:ff:ff:ff:ff:bb";
  m_destFinalId = "ff:ff:ff:ff:ff:bb";
...
/* Begin Elidio***********************************/
Interest&
Interest::setOrigID(const std::string& macaddress)
{
	m_origId = macaddress;
	m_wire.reset();
	return *this;
...
Interest&
Interest::setDestFinalID(const std::string& macaddress)
{
...
//
// Interest&
// Interest::setsCoordX(const double& xcoord)
// {
// 	m_sCoordX = xcoord;
// 	m_wire.reset();
// 	return *this;
...
//
// Interest&
// Interest::setsCoordY(const double& ycoord)
// {
// 	m_sCoordY = ycoord;
// 	m_wire.reset();
// 	return *this;
...
//
// Interest&
// Interest::setSpeedX(const double& xspeed)
// {
// 	m_SpeedX = xspeed;
// 	m_wire.reset();
// 	return *this;
...
//
// Interest&
// Interest::setSpeedY(const double& yspeed)
// {
// 	m_SpeedY = yspeed;
// 	m_wire.reset();
// 	return *this;
...
//
// Interest&
// Interest::setTimeA(const uint32_t& time_a)
// {
// 	m_TimeA = time_a;
// 	m_wire.reset();
// 	return *this;
...
//
// Interest&
// Interest::setTimeD(const uint32_t& time_d)
// {
// 	m_TimeD = time_d;
// 	m_wire.reset();
// 	return *this;
...
//
// Interest&
// Interest::setDirection(const uint32_t& direction)
// {
...
//
// Interest&
// Interest::setAcceleration(const double& acceleration)
// {
...
//   if (interest.getOrigID()) {
//     printOne("OrigId=", static_cast<unsigned>(*interest.getOrigID()));
//   }
