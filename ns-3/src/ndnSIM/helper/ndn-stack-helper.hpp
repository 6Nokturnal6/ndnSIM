...
public:
  ...
  */
  ...
  // Elidio
  void
  SetDefaultRoutes(bool needSet, uint64_t RsuId);
  ...
  // Elidio
  void
  Update(Ptr<Node> node, bool fromForwarder);
...
private:
  ...
  uint64_t m_RsuId = 666; // Invalid value. Elidio.
  ...
  // friend class ::nfd::fw::Forwarder; // Elidio NOT GOOD
};
