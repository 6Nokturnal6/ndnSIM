...
AppLinkService::onReceiveInterest(const Interest& interest)
{
  ...
  // }
  // else{
  //   std::cout << "[AppLinkService::onReceiveInterest]... Interest." << std::endl;
  // }

  this->receiveInterest(interest, 0);// from 0 to fromId
}
...
AppLinkService::onReceiveData(const Data& data)
{
  ...
  // }
  // else{
  //   std::cout << "[AppLinkService::onReceiveData]... Data." << std::endl;
  // }


  this->receiveData(data, 0);// from 0 to fromId
}
