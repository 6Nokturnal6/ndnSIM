...
//   std::cout << " Name of the packet: " << i->Entry::getFullName() << std::endl;
//   std::cout << " Name of the packet: " << i->Entry::getName() << std::endl;
  this->doAfterInsert(i);
//   std::cout << "cs-policy: Name of the packet: " << i->Entry::getName() << std::endl;
//   auto val = i->Entry::getNodePosition();
  //std::cout << "cs-policy: lets verify: " << "\n" << *val << "\n";
}
...
{
  BOOST_ASSERT(m_cs != nullptr);
//   std::cout << " Name of the packet do evict: " << i->Entry::getName() << std::endl;
