...
{
  // std::cout << "RIB..23.. Prefix: " << prefix << " - Route: " << route << std::endl;
  auto ribIt = m_rib.find(prefix);
  ...
  if (ribIt != m_rib.end()) {
    ...
    // New name prefix
    // std::cout << "RIB..67..: prefix: " << prefix << " route: " << route << std::endl; // Ok. From producer. 20240412
