...
public:
  ...
  operator==(const FibUpdate& other) const
  {
    return (this->name == other.name &&
            ...
            this->endpointId == other.endpointId && /*Elidio*/
            this->action == other.action);
  }

  static FibUpdate
  createAddUpdate(const Name& name, const uint64_t faceId, const uint64_t cost, const uint64_t endpointId);// const uint64_t endpointId
...
operator<<(std::ostream& os, const FibUpdate& update)
{
  os << "FibUpdate("
	 ...
	 << "endpointId: " << update.endpointId << ", "; /*Elidio endpointId ?*/
