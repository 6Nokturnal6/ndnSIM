...
public: // triggers
  ...
  virtual void
  insertNeighborData(const FaceEndpoint& ingress, const ndn::util::Nmsi& nmsi, const uint32_t currentNodeId, const std::string& filename);

  virtual void
  insertNeighborInterest(const FaceEndpoint& ingress, const Interest& interest, const std::string& filename);

  // virtual void
  // insertNeighbor(const pit::Entry& pitEntry, const FaceEndpoint& ingress, const Data& data, const std::string& filename);

  // virtual void
  // insertNeighbor(const pit::Entry& pitEntry, const FaceEndpoint& ingress, const Interest& interest, const std::string& filename);
