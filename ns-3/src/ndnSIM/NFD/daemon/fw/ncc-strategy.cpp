                                  ...
                                  const shared_ptr<pit::Entry>& pitEntry)
{
  ...
  if (bestFace != nullptr && fibEntry.hasNextHop(*bestFace, 0) &&  /*Elidio*/
  ...
  if (previousFace != nullptr && fibEntry.hasNextHop(*previousFace, 0) &&  /*Elidio*/
...
NccStrategy::doPropagate(FaceId inFaceId, weak_ptr<pit::Entry> pitEntryWeak)
{
  ...
  auto inRecord = pitEntry->getInRecord(*inFace, 0); // Elidio: 0
