...
public:
  ...
  public:
    ...
    // Elidio
    /** \brief Enable encoding and decoding of SpeedTags
     *
     *  To enable, set value of enableSpeedTags option to a function that generates `shared_ptr<SpeedTag>`
     */
    std::function<std::shared_ptr<ndn::lp::SpeedTag>()> enableSpeedTags;
  };
