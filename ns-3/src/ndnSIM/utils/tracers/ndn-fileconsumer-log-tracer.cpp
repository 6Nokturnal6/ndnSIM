...
void
FileConsumerLogTracer::FileDownloadedTrace(Ptr<App> app, shared_ptr<const ndn::Name> interestName, double downloadSpeed, long milliSeconds)
{
...
void
FileConsumerLogTracer::FileDownloadedManifestTrace(Ptr<App> app, shared_ptr<const ndn::Name> interestName, long fileSize)
{
  *m_os << Simulator::Now().ToDouble(Time::S) << "\t" << m_node << "\t" << app->GetId() << "\t" << interestName->toUri() << "\t"
...
void
FileConsumerLogTracer::FileDownloadStartedTrace(Ptr<App> app, shared_ptr<const ndn::Name> interestName)
{
  *m_os << Simulator::Now().ToDouble(Time::S) << "\t" << m_node << "\t" << app->GetId() << "\t" << interestName->toUri() << "\t"
