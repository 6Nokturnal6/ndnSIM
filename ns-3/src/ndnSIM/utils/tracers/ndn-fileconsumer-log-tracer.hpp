...
private:
  ...
  void
  FileDownloadedTrace(Ptr<App> app, shared_ptr<const ndn::Name> interestName, double downloadSpeed, long milliSeconds);

  void
  FileDownloadedManifestTrace(Ptr<App> app, shared_ptr<const ndn::Name> interestName, long fileSize);

  void
  FileDownloadStartedTrace(Ptr<App> app, shared_ptr<const ndn::Name> interestName);
